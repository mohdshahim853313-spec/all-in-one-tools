      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4 mt-8">
          <div>
            ...
            <p className="text-gray-400">Apne likhe hue text ko alag-alag aawazon mein sunein (AI Voice Reader).</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="relative">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-[10px] text-gray-500 mt-2">
                    * Awazein aapke device aur browser par depend karti hain.
                  </p>
                </div>
                ...
                <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg flex items-start gap-2">
                  ...
                  <p className="text-[10px] text-blue-300/80 leading-relaxed">
                    Browser security ki wajah se aap is audio ko seedha MP3 mein download nahi kar sakte. Yeh tool padhne (listening) ke liye best hai.
                  </p>
                </div>
          ...
          <div className="lg:col-span-2 bg-[#151B2B] rounded-2xl border border-gray-800 shadow-xl overflow-hidden min-h-[500px] flex flex-col relative">
            ...
            <div className="flex-1 p-6 flex flex-col">
              <div className="flex justify-between items-center mb-4">
                ...
                {text.length > 0 && (
                  <button onClick={clearText} className="text-xs text-red-400 hover:text-red-300 hover:underline">
                    Clear Text
                  </button>
                )}
              </div>
              <textarea 
                ...
                placeholder="Yahan apna text paste karein, aur Play button dabayein..."
                className="w-full flex-1 min-h-[250px] p-5 bg-[#0B0F19] border border-gray-700 rounded-xl text-gray-300 outline-none resize-none leading-relaxed focus:border-green-500 transition-colors"
              />
            </div>

            {/* Playback Controls Box */}
            <div className="bg-[#0B0F19] p-6 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                <button 
                  ...
                  className="px-5 py-3 bg-gray-800 text-white rounded-xl hover:bg-red-500/20 hover:text-red-400 transition-colors disabled:opacity-50 flex items-center gap-2 font-bold"
                >
                  ⏹️ Stop
                </button>
                ...
                {isPlaying ? (
                  <button 
                    onClick={handlePause}
                    className="flex-1 sm:flex-none px-8 py-3 bg-yellow-500/20 text-yellow-400 border border-yellow-500/50 rounded-xl hover:bg-yellow-500 hover:text-gray-900 transition-colors flex items-center justify-center gap-2 font-bold"
                  >
                    ⏸️ Pause
                  </button>
                ) : (
                  <button 
                    onClick={handlePlay}
                    disabled={!text.trim()}
                    className="flex-1 sm:flex-none px-8 py-3 bg-gradient-to-r from-green-500 to-teal-500 text-white rounded-xl hover:shadow-[0_0_20px_rgba(34,197,94,0.4)] transition-all flex items-center justify-center gap-2 font-bold disabled:opacity-50"
                  >
